...
class Readme {
  ...
  save() {
    _fs2.default.writeFile(_path2.default.join(process.cwd(), 'README.md'), this.toString(), err => {
      if (err) throw err;
    });
  ...
  toString() {
    const template = `<p align="center"><a href="${this.homepage}" target="_blank"><img src="http://47.93.19.167:5000/readme/logo?name=${this.name}"></a></p>
